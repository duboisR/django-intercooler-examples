...
from main.views import (
	...
	ClickToLoadTemplateView, BulkUpdateUITemplateView, LazilyLoadingAnElementView,
	InlineFormValidationView, InlineRowRemovalView, ActiveSearchView,
	DependentSelectView, HistorySupportView, JobRunnerView, BootstrapConfirmView
)
